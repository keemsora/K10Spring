...
public class DIController {
	...
	public String myCal(Model model) {
		...
		webapp하위의 resources디렉토리와 혼동하지 않도록 주의한다.
		*/
		...
		*/
		...
		/*
		XML설정파일에서 생성한 빈을 getBean()을 통해 주입받아 참조변수에
		할당한다. new연산자를 통해 생성한 것과 동일하지만 외부 설정파일에서
		미리 생성한 것을 주입(injection)받아 사용하고 있다.
		*/
		CalculatorDTO myCal =
	...
	public ModelAndView myAvengers() {
		...
		//캡틴 빈을 주입받은 후 정보 출력을 위해 문자열을 저장
		...
		//model객체에 정보 저장과 뷰에 대한 설정을 동시에 처리
